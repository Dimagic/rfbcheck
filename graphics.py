from PyQt5 import QtGui, QtCore, QtSvg, uic, QtWidgets
...
class ArcItem(QtWidgets.QGraphicsItem):
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.diagramScene = QtWidgets.QGraphicsScene(self)
        uic.loadUi('arrow.ui', self)
        self.graphicsView.setScene( self.diagramScene )
        t1 = QtWidgets.QGraphicsRectItem(QtCore.QRectF(20,20,100,50 ))
...
#         t1.setFlag( QtGui.QGraphicsItem.ItemIsSelectable | QtGui.QGraphicsItem.ItemIsMoveable )
        ...
        p1 = QtWidgets.QGraphicsEllipseItem(QtCore.QRectF(200,200,100,50))
