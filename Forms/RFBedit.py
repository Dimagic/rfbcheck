...
class Ui_RFBedit(object):
    def setupUi(self, RFBedit):
        ...
        RFBedit.resize(546, 389)
        RFBedit.setMinimumSize(QtCore.QSize(513, 389))
        icon = QtGui.QIcon()
        ...
        self.widget.setGeometry(QtCore.QRect(10, 100, 521, 194))
        self.widget.setObjectName("widget")
        self.gridLayout = QtWidgets.QGridLayout(self.widget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.tableAtrSettings = QtWidgets.QTableWidget(self.widget)
        ...
        self.gridLayout.addWidget(self.tableAtrSettings, 0, 0, 1, 1)
        self.tableTestSettings = QtWidgets.QTableWidget(self.widget)
        ...
        self.tableTestSettings.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.gridLayout.addWidget(self.tableTestSettings, 0, 1, 1, 1)
