# RA00297  ->  b'aaaa54d028556677003220088e0000000113'
#              b'aaaa54d028556677003220080c0000000090'
...
class BitAlarmTest(QtCore.QThread):
    ...
    def test(self):
        ...
        if gain == False and wasAlarm == True:
...
##        print(str(rx).find('3220'))
    ...
    def getLoFreq(self):
        try:
            file = os.path.join(os.path.dirname(__file__),'..','setFiles',self.parent.rfbTypeCombo.currentText() + '.CSV')
            f = open(file,'r')
            f.close()
